...
// ab hier begimt das submit

const form = document.getElementById("survey-form");

form.addEventListener("submit", (event) => {
  event.preventDefault(); // prevent rl

  const data = {
    question1: Number(document.getElementById("question1").value),
    question2: Number(document.getElementById("question2").value),
    question3: Number(document.getElementById("question3").value),
    question4: Number(document.getElementById("question4").value),
    question5: Number(document.getElementById("question5").value),
  };

  addDoc(collection(db, "User"), data)
    .then(() => {
      console.log("Erfolgreich exportiert");
      form.reset(); // reset
    })
    .catch((error) => {
...
// form.addEventListener("submit", (event) => {
//   event.preventDefault(); //undo reload
